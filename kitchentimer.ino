/*****************************************************************************
  This is the "kitchen timer" sketch.
  ...
  wiring for a vroom eboxmaker himalaya board.
...
// WiFi stuff
const char* ssid     = "swlan371";
const char* password = "1461131146113145";
      ...
      if (client.available()) {
        ...
        if (rd == '\n') {
          if (linebuf.length() == 0) {
            ...
            client.println("<META HTTP-EQUIV=\"refresh\" CONTENT=\"" + refr + "; url=http://192.168.178.43\">");
